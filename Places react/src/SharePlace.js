...
class PlaceFinder {
  constructor() {
    ...
    const locateUserBtn = document.getElementById('locate_btn');
    this.shareBtn = document.getElementById('share_btn');
  ...
  sharePlaceHandler() {
    const sharedLinkInputElement = document.getElementById('share_link');
